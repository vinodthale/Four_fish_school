// =============================================================================
// TEST 06: Mass Conservation
// =============================================================================
// Validates global mass budget over time
// =============================================================================
...
int main(int argc, char* argv[])
{
    ...
    TestUtils::printTestHeader("Mass Conservation", 06);
    ...
    total_timer.stop();
    logger.logTestResult("Test 06: Mass Conservation", test_passed);
