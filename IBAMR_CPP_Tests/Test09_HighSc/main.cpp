// =============================================================================
// TEST 09: High Schmidt Number
// =============================================================================
// Tests stability at Sc = 100-1000
// =============================================================================
...
int main(int argc, char* argv[])
{
    ...
    TestUtils::printTestHeader("High Schmidt Number", 09);
    ...
    TestUtils::printTestFooter("Test 09: High Schmidt Number", test_passed,
