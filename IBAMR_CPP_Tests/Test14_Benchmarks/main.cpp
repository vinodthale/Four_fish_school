// =============================================================================
// TEST 14: Benchmark Comparison
// =============================================================================
// Compares to Lei et al. and Kamran et al. data
// =============================================================================
...
int main(int argc, char* argv[])
{
    ...
    TestUtils::printTestHeader("Benchmark Comparison", 14);
...

    {
        ...
        Pointer<AppInitializer> app_initializer = new AppInitializer(argc, argv, "test14.log");
    ...
    total_timer.stop();
    logger.logTestResult("Test 14: Benchmark Comparison", test_passed);

    TestUtils::printTestFooter("Test 14: Benchmark Comparison", test_passed,
