...
// =============================================================================
// Validates IB-scalar coupling with moving ellipsoid
// =============================================================================
...
int main(int argc, char* argv[])
{
    ...
    TestUtils::printTestHeader("Moving Immersed Boundary", 10);
    ...
    total_timer.stop();
    logger.logTestResult("Test 10: Moving Immersed Boundary", test_passed);

    TestUtils::printTestFooter("Test 10: Moving Immersed Boundary", test_passed,
